;; StacksLend - Simple P2P Lending Contract
;; Based on proven marketplace pattern - simple on-chain storage
...
;; create loan offer
(define-public (create-offer (amount uint) (interest-rate uint) (max-duration uint) (min-collateral uint))
